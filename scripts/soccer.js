...
function renderCards(timeLeft) {
    ...
    if(num1 > num2)
    {
        ...
        cardImages1.setAttribute('src', 'images/soccer0'+ num1.toString() + '.png');
        cardImages2.setAttribute('src', 'images/soccer0'+ num2.toString() + '.png'); 
    }
    else if(num1 < num2)
    {
        cardImages1.setAttribute('src', 'images/soccer0'+ num1.toString() + '.png');
    ...
    function countdown() {
      if (timeLeft == -1) {
        ...
        let pointsAddition1 = Math.floor(Math.random() * 2); //originally *4
        let pointsAddition2 = Math.floor(Math.random() * 2);
        let modTime = Math.floor(Math.random() * 10); //originally + 4
